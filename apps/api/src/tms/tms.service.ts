...
export class TmsService {
    ...
    async recordTemperature(shipmentId: string, temperature: number, sensorId: string) {
        ...
        if (temperature > 8.0 || temperature < 2.0) {
            console.warn(`[ALERT] Shipment ${shipmentId} temperature excursion: ${temperature}°C`);
